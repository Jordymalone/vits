...
def load_speaker_dict():
    ...
    with open(f'/home/p76131482/Linux_DATA/model/vits/filelists/no_double_phoneme_zh_tw/mixed_5_id.txt', 'r') as f:
...
hps = utils.get_hparams_from_file("logs/no_double_phoneme_zh_tw/config.json")
...
def get_symbols():
    ...
    with open(f'filelists/no_double_phoneme_zh_tw/lang_phones.txt','r',encoding='utf-8') as f:
...
# 新tw 用 421000
# 新en 用 607000
use_g_pth_file = 'G_240000'
_ = utils.load_checkpoint(f"logs/no_double_phoneme_zh_tw/{use_g_pth_file}.pth", net_g, None)
...
if __name__ == '__main__':
    ...
    #     else:
    # test_string = ['ie13', 'g1', 'ei13', 'uo13', 'ia11', 'l1', 'i14', 'a15']
    # test_string = ['g1', 'ei13', 'n1', 'i13', 'z1', 'ii14', 'j1', 'i13', 'ia11', 'l1', 'i14']
    ...
    # result = "dl0 i01 u07 h0 uat08 sc0 io01 b0 o03"
    result = "ts0 ui01 k0 o02 ai02 kh0 au07 ph0 ue05 tsc0 iah08"
    result = "x1  iong12 zh1 uang14 uei11 u13"
    result = "zh1 ang13 d1 e15 j1 iou14 x1 iang14 c1 ang11 ing12 p1 a14 p1 a14"

    result = "uo13 i12 d1 ing14 iao14 iong11 iou13"
    result = "uo13 m1 en15 ie13 sh1 iii14 i11 iang14"
    result = "i14 zh1 iii12 z1 ai14 ia11 i14 a15"
    result = "v13 a11 i12 i14 q1 i13 ch1 iii11 f1 an14"
    result = "i11 g1 e15 van14 uang14"

    # ', '
    print(result)
    synthesis_file(language = "zh", speaker_id = 4, net_g = None)
    # synthesis(result, 92, 92, "nodouble05.wav", False, "TW", )
